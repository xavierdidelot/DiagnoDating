...
then this is readily available for validation and we therefore focus on this case throughout this article
...
with mean clock rate $\mu=10$ substitutions per year and relaxation parameter $\omega=5$.
...
We applied BactDating \citep{Didelot2018} to reconstruct the dated tree, incorrectly assuming a strict clock model.
The clock rate was estimated to be 10.5 [9.4;11.6] and the root date 2008.6 [2008.1;2009.1] which is approximately correct.
...
Running BactDating with correct additive relaxed clock model. 
Good residuals. Figure \ref{fig:example}E and Figure \ref{fig:example}F.
mu 11.3 [8.8;14.1]
omega 6.4 [4.2;8.9]
Root date=2008.9 [2007.7;2009.8].
