...
and applying $k=m^2/v$ and $\theta=v/m$. 
\footnote{Would need justification.}
...
\footnote{In practice this procedure works well for iid case (cf script resampling.R) but not well for non-iid case. Dividing the variance in the posterior by 4 helps (cf line 49 of resid.R) but is a temporary ad hoc fix. }
