...
Using simulation with relaxed clock model and inference with strict clock model.
...
\item Note that Anderson-Darling was used in \citep{lauNewModelDiagnostics2014} but not
sure which one.
\end{itemize}
