...
\subsection*{Diagnostic of a single dated phylogeny}
...
All code and data needed to replicate the results are included in the ``run'' directory of the \emph{DiagnoDating} repository.
