...
a4=runDating(tree,dates,algo='TreeTim')

pdf('exampleS2.pdf',10,10)
par(mfrow=c(2,2),mar=c(4,4,2,2))
plotResid(a1,3,main='',xlim=c(-4,4),xlab='Residuals',ylim=c(0,0.4),breaks=seq(-10,10,0.5))
fig_label('A',cex=2)
plotResid(a2,3,main='',xlim=c(-4,4),xlab='Residuals',ylim=c(0,0.4),breaks=seq(-10,10,0.5))
fig_label('B',cex=2)
plotResid(a3,3,main='',xlim=c(-4,4),xlab='Residuals',ylim=c(0,0.4),breaks=seq(-10,10,0.5))
fig_label('C',cex=2)
plotResid(a4,3,main='',xlim=c(-4,4),xlab='Residuals',ylim=c(0,0.4),breaks=seq(-10,10,0.5))
fig_label('D',cex=2)
dev.off()
