...
But it also include incorrect assumptions made when running a dating analysis, for example using an inappropriate clock model. 
...
- A Mendel test has been proposed to detect when confounding mighy happen, but this will flag an issue even if there is no structure and no problem with dating, cf `struture-test.Rmd`
