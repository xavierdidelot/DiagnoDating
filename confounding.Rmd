...
First we generate a dated tree with root in 2000 and two populations existing for only a year each and separated by 5 years.
...
dt=simImports(localPopStart = 2010,importDates=2015,samplingStartDate = 2010,samplingEndDate = 2023,samplingNumber = 100,globalNeg = 10,NeFunImp = NeFunImp)
