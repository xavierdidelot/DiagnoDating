...
First we generate a dated tree with three populations. Each population is sampled 100 times in non-overlapping windows of 0.1 year each.

```{r}
library(DiagnoDating,quietly=T)
set.seed(5)
s=list(runif(100,2010,2010.1),runif(100,2010.1,2010.2),runif(100,2010.2,2010.3))
...
Run and diagnose BactDating analysis:
```{r}
